...
| --- | --- | --- | --- | --- |
| 2025-10-13 | Salvage | Refactored the live data ingestion worker to use the shared DB service with transactional play-by-play inserts. | `scripts/ingest-live-data.js`, `api/database/game-events-helper.js`, `api/database/schema.sql` | Live ingestion refactor notes (2025-10-13) |
