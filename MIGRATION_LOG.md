...
| 2025-10-13 | Decommission | Removed the legacy Vite/React 18 SPA scaffold (App.jsx, main.jsx, CSS) and deleted the obsolete Vite build chain. | `src/` directory, `vite.config.js`, legacy CSS bundles. | Commit pending (Next.js migration) |
| 2025-10-13 | Salvage | Stood up Next.js 15 App Router with Tailwind dark-mode tokens, ported scoreboard/box score/standings into TypeScript routes under `app/baseball/ncaab/*`, and wired new mobile navigation + conference filters. | `app/` route tree, `styles/theme.ts`, Tailwind config, new React 19 components. | Commit pending (Next.js migration) |
